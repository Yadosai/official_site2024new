<template>
    <div class="body">
    <h1>企画コンポーネント</h1>
    <item id=1 title="ゆかこん" :imgUrl="src1" holder="一年生向け企画" place="メインステージ" date="5月31日：14:00～15:00" description="やどかり祭を最高に盛り上げるメイン企画。各チームが個性的なパフォーマンスで観客の皆さんを魅了し
    優勝を目指します。ゆかたを着た出演者を中心としたチーム一丸となってのパフォーマンスは必見です。" 
    />
    <item id=2 title="神輿" :imgUrl="src2" holder="一年生向け企画" place="メインストリート" date="6月1日：14:00～15:00" description="hugahugahogehoge"/>
    <timeTable_1 />
    <timeTable_2 />
</div>
</template>
