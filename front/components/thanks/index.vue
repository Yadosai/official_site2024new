<template>
    ...
    <div class="bigsponsorContainer">
        ...
        <sponsorItem sponsorUrl="https://mentoru.jp/info/tsukuba.html" sponsorLogoUrl="/img/mentoru.png" :sponsorDescript="MentoruText"/>
    </div>
    ...
    <div class="sponsorsContainer">
        ...
        <div class="miniCon">
            ...
            <span>カラオケBanBanつくば学園店</span>
            <span>POTATO'S CAFE craftfries</span>
            <span>クーロンヌ　つくば</span>
            <span>フライングガーデンつくば西平塚店</span>
            <span>(株)アジア住販天久保店</span>
            <span>らーめん逆流</span>
            <span>(株)井上フード（カレー屋＆粉クリ）</span>
            <span>牛角つくばテクノパーク桜店</span>
            <span>桂不動産</span>
